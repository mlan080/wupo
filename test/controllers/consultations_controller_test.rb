...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference("Consultation.count") do
      post consultations_url, params: { consultation: { description: @consultation.description, end_time: @consultation.end_time, location: @consultation.location, start_time: @consultation.start_time, text: @consultation.text, title: @consultation.title } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { description: @consultation.description, end_time: @consultation.end_time, location: @consultation.location, start_time: @consultation.start_time, text: @consultation.text, title: @consultation.title } }
